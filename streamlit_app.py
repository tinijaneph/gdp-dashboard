...
with tab1:
    ...
    with col2:
        ...
        danger_data = data['danger_correlation'].sort_values('DangerCoefficient', ascending=False).head(top_n)
...
# Tab 4: Species-Specific Patterns
with tab4:
